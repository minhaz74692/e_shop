...
import 'package:e_waste/screens/order_confiremed.dart';
...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  Widget build(BuildContext context) {
    // final pb = context.watch<EWasteProvider>();
    // List<EWasteProvider> productListInCart = pb.productListOfCart;
    double deliveryFee = 40;
    double totalPrice = deliveryFee;
    // List<EWasteProvider> sortedProductList = productListInCart.toSet().toList();
    // for (EWasteProvider product in productListInCart) {
